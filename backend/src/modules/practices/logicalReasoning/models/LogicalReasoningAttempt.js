// src/modules/practices/logicalReasoning/models/LogicalReasoningAttempt.js
import mongoose from "mongoose";
import { ATTEMPT_STATE_VALUES, ATTEMPT_STATES } from "../../../common/constants/attemptStates.js";

const logicalReasoningAttemptSchema = new mongoose.Schema(
  {
    user: {
...
/* ================= INDEXES ================= */
logicalReasoningAttemptSchema.index({
  user: 1,
  completed: 1,
  deletedAt: 1,
});
