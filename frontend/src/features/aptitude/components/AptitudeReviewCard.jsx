// src/features/aptitude/components/AptitudeReviewCard.jsx

import cx from "../../../utils/cx.js";
import { CheckCircle2, XCircle, Lightbulb } from "lucide-react";

/**
 * Premium Aptitude Question Review Card
 */
const AptitudeReviewCard = ({ index, data }) => {
  const {
    question,
    options,
    correctIndex,
...
export default AptitudeReviewCard;
