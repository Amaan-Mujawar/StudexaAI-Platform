// src/features/verbalReasoning/components/VerbalReviewCard.jsx

import cx from "../../../utils/cx.js";
import { CheckCircle2, XCircle, Lightbulb } from "lucide-react";

/**
 * Premium Verbal Reasoning Review Card
 */
const VerbalReviewCard = ({ index, data }) => {
  const {
    question,
    options,
    correctIndex,
...
export default VerbalReviewCard;
