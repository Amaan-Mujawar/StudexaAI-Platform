// src/features/verbalReasoning/components/VerbalGenerator.jsx

import { useState } from "react";
import { Sparkles, Brain, Info } from "lucide-react";
import cx from "../../../utils/cx.js";

const VerbalGenerator = ({ onGenerate, loading }) => {
      ...
      <div className="mb-4">
        <div className="flex items-center gap-2 mb-0.5">
          ...
          <h2 className="text-lg font-extrabold text-text-title">
            Start Verbal Mastery
          </h2>
        </div>
        <p className="text-[12px] font-semibold text-text-muted">
          Improve your vocabulary, comprehension, and grammatical reasoning.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div className="space-y-1.5">
            ...
            >
              ...
              <option value="hard">Hard — Advanced Comprehension</option>
            </select>
          </div>
...
export default VerbalGenerator;
