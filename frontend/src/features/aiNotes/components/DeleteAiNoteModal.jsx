// src/features/aiNotes/components/DeleteAiNoteModal.jsx
                ...
                <div className="relative p-6 sm:p-8">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="mt-2 text-sm font-semibold text-text-muted">
                      Are you sure you want to remove "{note?.subject}"? This action cannot be undone.
                    </p>
                  </div>
...
export default DeleteAiNoteModal;
