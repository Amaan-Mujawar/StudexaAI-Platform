// src/features/logicalReasoning/components/LogicalGenerator.jsx

import { useState } from "react";
import { Sparkles, Brain, Info } from "lucide-react";
import cx from "../../../utils/cx.js";

const LogicalGenerator = ({ onGenerate, loading }) => {
    ...
    <div className="rounded-2xl border border-border bg-white/75 p-5 shadow-card backdrop-blur-xl">
      <div className="mb-4">
        ...
        <p className="text-[12px] font-semibold text-text-muted">
          Challenge your brain with patterns, deductions, and logic puzzles.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div className="space-y-1.5">
            ...
            >
              <option value="easy">Easy — Basic Patterns</option>
              <option value="medium">Medium — Mixed Deductions</option>
              <option value="hard">Hard — Complex Logic</option>
            </select>
          </div>
...
export default LogicalGenerator;
