// src/features/logicalReasoning/components/LogicalReviewCard.jsx

import cx from "../../../utils/cx.js";
import { CheckCircle2, XCircle, Lightbulb } from "lucide-react";

/**
 * Premium Logical Reasoning Review Card
 */
const LogicalReviewCard = ({ index, data }) => {
  const {
    question,
    options,
    correctIndex,
...
export default LogicalReviewCard;
