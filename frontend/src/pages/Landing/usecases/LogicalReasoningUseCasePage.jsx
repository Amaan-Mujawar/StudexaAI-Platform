// src/pages/Landing/usecases/LogicalReasoningUseCasePage.jsx
...
const pillars = [
  {
    title: "Interview-style reasoning",
    desc: "Practice the same patterns used in hiring tests and real assessments.",
    icon: <Trophy className="h-5 w-5 text-brand-blue" />,
  },
  {
    title: "Clarity under pressure",
    desc: "Train decision-making and structured thinking with time-aware rounds.",
    icon: <Timer className="h-5 w-5 text-brand-blue" />,
  },
  {
    title: "Smarter improvements",
    desc: "Learn from explanations and remove repeated mistakes permanently.",
...
const highlights = [
  {
    ...
    desc: "StudexaAI enforces non-repetitive practice logic across attempts.",
    icon: <Lock className="h-5 w-5 text-brand-blue" />,
  },
  {
    title: "Attempt integrity",
    desc: "Attempts have a lifecycle to keep practice structured and fair.",
    icon: <BadgeCheck className="h-5 w-5 text-brand-blue" />,
  },
  {
    title: "Review explanations",
    desc: "After completion, you can learn from every question you missed.",
    icon: <BookOpen className="h-5 w-5 text-brand-blue" />,
  },
  {
    title: "History & progress",
    desc: "Your attempts remain stored for future revision and improvement.",
    icon: <BarChart3 className="h-5 w-5 text-brand-blue" />,
  },
];

const sampleFlow = [
  "Start a Logical Reasoning round",
  "Solve unique questions (fresh attempt)",
  "Submit to lock and score the attempt",
  "Review explanations + patterns",
  "Reattempt later and improve",
];

const LogicalReasoningUseCasePage = () => {
  useEffect(() => {
          ...
          >
            ...
            >
              ...
              <span className="block text-brand-blue">
                Train structured thinking like a top candidate.
              </span>
            </motion.h1>
            ...
            >
              Logical Reasoning is where interviews are won — not by memorizing,
              but by staying calm, structured, and consistent. StudexaAI turns
              practice into a loop so improvement becomes measurable and repeatable.
            </motion.p>
              ...
              <div className="relative z-10 grid grid-cols-1 gap-8 lg:grid-cols-12">
                ...
                <div className="lg:col-span-7">
                  ...
                  <h2 className="mt-2 text-2xl font-extrabold tracking-tight text-text-title sm:text-3xl">
                    Stop random practice. Start structured reasoning growth.
                  </h2>

                  <p className="mt-3 text-sm leading-relaxed text-text-body sm:text-base">
                    Learners usually practice reasoning from multiple sources,
                    but without a loop. StudexaAI fixes this by keeping attempts,
                    history, review explanations, and continuous improvement inside
                    ...
                    <div className="mt-6 rounded-2xl border border-border bg-white px-5 py-4 shadow-card">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-xs leading-relaxed text-text-body">
                            The real upgrade is not “more questions”. It’s better
                            reasoning patterns through review and repetition-free
                            practice.
                          </p>
                        </div>
                      </div>
          ...
          >
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-extrabold text-text-title">
                    Ready to start Logical Reasoning practice?
                  </p>
...
export default LogicalReasoningUseCasePage;
